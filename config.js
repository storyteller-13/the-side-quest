...
window.CONFIG = {
  ...
  zones: [
    { name: 'THE DARK STREETS IN BERLIN',   bg: '#1a0028', mapEmoji: '🧛🏼', monsterCount: 8,  monsterSpeed: 1.0, fleeSpeed: 6,
    ...
    { name: 'THE GHOST ISLAND IN MALAYSIA',     bg: '#1a0800', mapEmoji: '👻', monsterCount: 26, monsterSpeed: 1.8, fleeSpeed: 14,
      excuse: "MY MOM IS CALLING!",
      taunts: ["I'M NOT READY FOR COMMITMENT!"] },
    { name: 'THE FINAL FORTRESS IN DENVER', bg: '#08081a', mapEmoji: '👽', monsterCount: 30, monsterSpeed: 2.0, fleeSpeed: 16,
      excuse: "I AM SCARED!",
      taunts: ["MAYBE IN ANOTHER LIFE!"] },
    { name: 'THE SECRET ROSE GARDEN',    bg: '#1a0512', mapEmoji: '🌹', monsterCount: 35, monsterSpeed: 2.2, fleeSpeed: 0,
      excuse: null,
